<?php
// filepath: c:\wamp64\www\New folder\show_your_boats.php
...
// Fetch boats registered by the logged-in fisherman
$fisherman_id = $_SESSION['user_id'];
$sql = "SELECT id, boat_name, registration_number, capacity, status FROM boat_registrations WHERE fisherman_id = '$fisherman_id'";
...
<head>
    ...
    <title>Your Boats - Fishing Port Management System</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <?php else: ?>
            <p>You have not registered any boats yet.</p>
        <?php endif; ?>
