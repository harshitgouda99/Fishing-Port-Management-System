...
<body>
    ...
    <div class="dashboard-container">
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $row['arrival_direction'] ?: 'Not Arrived'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
        ...
        <?php endif; ?>
        <p>
            <a href="fisherman_dashboard.php" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background: #007BFF; color: #fff; text-decoration: none; border-radius: 5px; font-size: 1em; transition: background 0.3s ease;">
                Back to Dashboard
            </a>
        </p>
    </div>
