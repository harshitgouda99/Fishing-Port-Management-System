...
$sql = "SELECT id, user_id, transaction_type, amount, status, created_at FROM transactions ORDER BY created_at DESC";
...
<head>
    ...
    <title>Manage Transactions - Fishing Port Management System</title>
